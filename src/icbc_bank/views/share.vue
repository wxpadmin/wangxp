        ...
        <div class="share">
            ...
            <div class="share-box">
                ...
                <div class="active-detail">
                    ...
                    <p class="down-font">点击下方按钮，下载工银“e生活”，进入爱享流量世界！</p>
                    <a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.icbc.elife" class="down-app">立即下载</a>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            init(){
                let _this = this
                var option =  {
                    title: '我在工商银行免费获得'+_this.size+'M流量-全国三网通用', // 分享标题 主标题:我在工商银行免费获得388M全国、三网流量
                    desc: "60万G免费流量，等你来拿！", // 分享描述  副标题: 60万G免费流量，等你来拿
                    link: location.protocol + "//"+location.host+'/api/icbc/redirect?redirect_url='+encodeURIComponent('/icbc_bank/index.html#/share?size='+_this.size),
